<?php
    ...
    /*****************************************/
    //檔案名稱：ad_fun_action2.php
    //後台對應位置：好好玩管理系統/好好玩國外報名
    //改版日期：2021.11.30
    //改版設計人員：Jack
    //改版程式人員：Jack
    /*****************************************/
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <span class="title elipsis">
                    <strong>國外旅遊報名資料　<?php echo $all_type; ?> - 數量：<?php echo $total_sizen; ?></strong> <!-- panel title -->
                </span>
            </div>
                        ...
                        <ul class="dropdown-menu">
                            <?php 
                                if($_SESSION["MM_UserAuthorization"] == "admin"){
                                    ...
                                    if($all_type == "已處理"){
                                        echo "<li><a href='ad_fun_action2.php' target='_self'><i class='icon-resize-horizontal'></i> 切換未處理</a></li>";
                                    }
                                }
                                if($_SESSION["MM_UserAuthorization"] == "admin"){
                            ...
                            <!-- <li><a href="ad_fun_action_add2.php"><i class="icon-plus-sign"></i> 新增報名資料</a></li> -->
                        </ul>
                    </div>　

                    <form id="searchform" action="ad_fun_action2.php?vst=full&sear=1" method="post" target="_self" class="form-inline pull-left" onsubmit="return chk_search_form()">
                            ...
                            if(!$result){
                                ...
                                foreach($result as $re){ 
                                    ...
                                    <tr>
                                        ...
                                        <td class="center">
                                            <?php
                                                if(chkDate($re["action_time"])){
                                                    echo Date_EN($re["action_time"],1)."　 ";
                                                }
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu pull-right">						
                                                    ...
                                                    <?php 
                                                        ...
                                                        if($re["all_type"] != "未處理"){
                                                            echo "<li><a href=\"javascript:Mars_popup('ad_fun_report.php?k_id=" .$re["k_id"]. "&ty=lovekeyin&rc=國外旅遊','','scrollbars=yes,status=yes,menubar=yes,resizable=yes,width=690,height=600,top=10,left=10');\"><i class='icon-list-alt'></i> 回報(".$report.")</a></li>";
                                                        }
                                                        if($_SESSION["MM_UserAuthorization"] == "admin" || $_SESSION["MM_Username"] == "jackal6043"){
                                    ...
                                    <tr>
                                        <td colspan="10" style="border-bottom: #666666 1px dotted">
                                            <?php
                                                ...
                                                echo changeDate($re["k_time"])."(<a href=\"javascript:Mars_popup('ad_fun_report.php?k_id=" .$re["k_id"]. "&ty=lovekeyin&rc=國外旅遊','','scrollbars=yes,status=yes,menubar=yes,resizable=yes,width=690,height=600,top=10,left=10');\">回報(".$report.")</a>，
...
<script type="text/javascript">
    ...
    function chk_search_form() {
        ...
        location.href = "ad_fun_action2.php?sear=1&vst=full&" + $("#keyword_type").val() + "=" + $("#keyword").val();
        return false;
    }
</script>