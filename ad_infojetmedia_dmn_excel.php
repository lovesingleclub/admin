...
<?php
/*****************************************/
//檔案名稱：ad_infojetmedia_dmn_excel.php
//後台對應位置：名單/發送記錄>DMN億捷創意(匯出Excel)
//改版日期：2021.11.11
//改版程式人員：Queena
/*****************************************/
...
$SQL = "Select * From infojetmedia_dmn Where 1 = 1".$subSQL." Order By times Desc";
$rs = $SPConn->prepare($SQL);
$rs->execute();
$result=$rs->fetchAll(PDO::FETCH_ASSOC);
header('Content-type:application/vnd.ms-excel');  //宣告網頁格式
header('Content-Disposition: attachment; filename='.date("Y-m-d").'media_dmn.xls');  //設定檔案名稱
?>
<html>
    <head>
        <meta charset="UTF-8">
