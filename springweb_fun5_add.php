...
/*****************************************/
//檔案名稱：springweb_fun5_add.php
//後台對應位置：春天網站系統/自訂ABOUT->新增about
//改版日期：2022.5.8
//改版設計人員：Jack
//改版程式人員：Jack
/*****************************************/
    ...
    <div id="content" class="padding-20">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form id="mform" name="mform" method="post" action="?st=save">
                    <div class="box-content">
                        <p>Title: <input name="title" id="title" style="width:80%;" value="<?php echo $title; ?>"></p>
                        <p>description: <input name="description" id="description" style="width:80%;" value="<?php echo $description; ?>"></p>
                        <p>keywords: <input name="keywords" id="keywords" style="width:80%;" value="<?php echo $keywords; ?>"></p>
