...
<form method="post" action="springweb_fun4_add.asp?st=edit">
    <p>
        <label>指向連結位置：</label>
    ...
    <p>../img/lovepy_noimg.jpg<br><img height=80 src="upload_image/../img/lovepy_noimg.jpg?t=1682" id="showimg"></p>
...
<script type="text/javascript">
    $(function() {
        $(".fileupload").each(function() {
            ...
            $this.fileupload({
                    url: "springweb_fun4_add.asp?st=upload&an=",
                    type: "POST",
                    dropZone: $this,
                    dataType: 'html',
                    autoUpload: false,
                    ...
                    add: function(e, data) {
                        ...
                        if (data.files) {
                            if ($("#d1").val().replace(/\s/g, '') == '') {
                                ...
                                data.url = "springweb_fun4_add.asp?st=upload&d1=" + $("#d1").val() + "&an=";
                                data.submit();
                            }
                        }
                    }
