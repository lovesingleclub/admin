...
<p></p>
<form id="fun_form" method="post" action="singleweb_fun10_add.php?st=add" onsubmit="return chk_form()">
    <p>
        <label>連結位置：
...
<script type="text/javascript">
    ...
    $(function() {
        $(".fileupload").each(function() {
            ...
            $this.fileupload({
                    url: "singleweb_fun10_add.php?st=upload&an=",
                    type: "POST",
                    dropZone: $this,
                    dataType: 'html',
                    autoUpload: false,
    ...
    $('#file_upload').uploadify({
    				...
    				'uploader' : 'springweb_fun1_add.php?st=upload&an=',
