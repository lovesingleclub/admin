...
<p></p>
<form id="fun_form" method="post" action="singleweb_fun12_add.asp?st=add" onsubmit="return chk_form()">
    <p>
        <label>連結位置：
    ...
    <center><button type="submit" class="btn btn-danger" style="width:40%;height:32px;">確認送出</button></center>
</form>
...
<script type="text/javascript">
    ...
    $(function() {
        $(".fileupload").each(function() {
            ...
            $this.fileupload({
                    url: "singleweb_fun12_add.asp?st=upload&an=",
                    type: "POST",
                    dropZone: $this,
                    dataType: 'html',
                    autoUpload: false,
