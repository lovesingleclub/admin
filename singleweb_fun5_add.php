                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><select name="ads_kind" id="ads_kind">
                                        ...
                                        <option value="私話題">私話題</option>
                                        <option value="結婚">結婚</option>
                                        <option value="一言難盡">一言難盡</option>
                                        <option value="戀愛中">戀愛中</option>
                                        <option value="單身中">單身中</option>
                                    </select></td>
                            </tr>
                            <tr>
                            <tr>
                                <td width="150" align="left" valign="middle">標題</td>
                                <td><input name="ads_title" id="ads_title" value="" class="form-control" style="width:60%;" required></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td colspan=3><input name="ads_showtime" id="ads_showtime" value="" class="datepicker" autocomplete="off" required></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td></td>
                                <td align="center"><input name="ads_pic" id="ads_pic" type="hidden" value=""><input name="acts" id="acts" type="hidden" value="ad"><input name="pid" type="hidden" id="pid" value="">
...
<script language="JavaScript">
    ...
    $(function() {
        ...
        $file_uploads1.fileupload({
                url: "singleweb_fun5_add.php?st=upload&ads_pic=",
                type: "POST",
        ...
        $file_uploads2.fileupload({
                url: "singleweb_fun5_add.php?st=upload2&id=",
                type: "POST",
