...
<form method="post" action="dmnweb_fun6_add.php?st=edit">
    ...
    <p><br><img height=80 src="datemenow_image/upload/?t=4774" id="showimg"></p>
...
<script type="text/javascript">
    $(function() {
        $(".fileupload").each(function() {
            ...
            $this.fileupload({
                    url: "dmnweb_fun6_add.php?st=upload&an=",
                    type: "POST",
                    dropZone: $this,
                    dataType: 'html',
                    autoUpload: false,
                    ...
                    add: function(e, data) {
                        ...
                        if (data.files) {
                            if ($("#d1").val().replace(/\s/g, '') == '') {
                                ...
                                data.url = "dmnweb_fun6_add.php?st=upload&d1=" + $("#d1").val() + "&an=";
                                data.submit();
                            }
                        }
                    }
