...
<body topmargin="0">
    <form name="form1" method="POST" action="?st=add&p_auto=1717">
                    ...
                    <fieldset>
                        ...
                        <table width="720" border="0" align="center" cellpadding="3">
                            <tr bgcolor="#FBE6E8">
                                <td>
                                    <div align="center">
                                        <font color="blue" size="3">徐采雯</font> - <font color="#FF3333" size="3">人事資料卡</font>
                                    </div>
                                </td>
                            </tr>
                            <tr bgcolor="#F0F0F0">
                                <td bgcolor="#F0F0F0" style="word-break:break-all">姓名：
                                    <input name="p_name" type="text" id="p_name" size="10" value="徐采雯">
                                    　身分證字號：
                                    <input name="p_user" type="text" id="p_user" value="F223916509" onBlur="NM_changeCase('p_user',0)" size="12">
                                    　出生日期：
                            ...
                            <tr bgcolor="#F0F0F0">
                                <td bgcolor="#FFFFE6" style="word-break:break-all">專線電話：
                                    <input name="phone_num" type="text" id="phone_num" size="20" value="">
                                    　專線電話建立時間：
                            ...
                            <tr bgcolor="#F0F0F0">
                                <td bgcolor="#F0F0F0" style="word-break:break-all">通訊地址：
                                    <input name="p_address" type="text" id="p_address" size="50" value="新北市中和區中正277-4號8F">
                                    　電話：
                                    <input name="p_ph1" type="text" id="p_ph1" size="3" maxlength="3" value="02">
                                    -
                                    <input name="p_ph2" type="text" id="p_ph2" size="15" value="82451083">
                                </td>
                            </tr>
                            <tr bgcolor="#F0F0F0">
                                <td bgcolor="#F0F0F0" style="word-break:break-all">戶籍地址：
                                    <input name="p_address2" type="text" id="p_address2" size="50" value="新北市土城區延祿里2鄰金城路3段183號17F">
                                    　手機：
                                    <input name="p_mobile" type="text" id="p_mobile" size="15" value="0953721982">
                                </td>
                            </tr>
                            <tr bgcolor="#F0F0F0">
                                <td bgcolor="#F0F0F0" style="word-break:break-all">緊急聯絡姓名：
                                    <input name="emergency_name" type="text" id="emergency_name" size="15" value="陳文龍-夫">
                                    　緊急聯絡電話：
                                    <input name="emergency_phone" type="text" id="emergency_phone" size="15" value="0939066443">
                                </td>
                            </tr>
                            <tr bgcolor="#F0F0F0">
                            ...
                            <tr bgcolor="#FBE6E8">
                                <td bgcolor="#F0F0F0" style="word-break:break-all">備註：
                                    <input name="p_note" type="text" id="p_note" size="100" value="">
                                </td>
                            </tr>
                            <tr bgcolor="#FBE6E8">
