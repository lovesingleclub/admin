...
Class Uploader
    ...
    Private Function DoUpload( stream, filename )
        ...
        Else
            ...
            rsState = CheckOrCreatePath(  GetDirectoryName(savePath) )
            'rsState = GetDirectoryName(savePath)
        End If
        
        stream.Close
        Set stream = Nothing
        
        if Session.Value("base64Upload") <> "" then Session.Value("base64Upload") = "" end if
    ...
    Private Function CheckOrCreatePath( ByVal path )
        ...
        For Each part in parts
            ...
            End If
        Next
        CheckOrCreatePath = fs.FolderExists(path)
    End Function
