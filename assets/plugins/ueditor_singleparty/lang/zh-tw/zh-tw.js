UE.I18N['zh-tw'] = {
    'labelMap':{
        ...
        'pasteplain':'純文本粘貼模式', 'selectall':'全選', 'print':'列印', 'preview':'預覽',
        ...
        'fontfamily':'字體', 'fontsize':'字型大小', 'paragraph':'段落格式', 'simpleupload':'單圖上傳', 'insertimage':'多圖上傳','edittable':'表格屬性','edittd':'單元格屬性', 'link':'超鏈接',
    ...
    'autoupload': {
        ...
        'loading':"正在上傳...",
        'loadError':"上傳錯誤",
        'errorLoadConfig': '後端配置項沒有正常載入，上傳插件不能正常使用！'
    },
    'simpleupload':{
        'exceedSizeError': '文件大小超出限制',
        'exceedTypeError': '文件格式不允許',
    ...
    'insertimage':{
        ...
        'imageLoadError':"圖片載入失敗！請檢查鏈接地址或網路狀態！",
    ...
    'charts':{
        'static':{
            ...
            'lang_cahrt_tip_description': '僅餅圖有效， 當滑鼠移動到餅圖中相應的塊上時，提示框內的文字的前綴',
    ...
    'help':{
        'static':{
            ...
            'lang_input_introduction':'UEditor是由百度web前端研發部開發的所見即所得富文本web編輯器，具有輕量，可定製，注重用戶體驗等特點。開源基於BSD協議，允許自由使用和修改代碼。',
