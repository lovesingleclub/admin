<?php
    ...
    /*****************************************/
    //檔案名稱：ad_fun_send_love_all_branch.php
    //後台對應位置：好好玩管理系統/好好玩國內報名->總發
    //改版日期：2021.11.30
    //改版程式人員：jack
    /*****************************************/
    ...
    if($_REQUEST["state"] == "add"){        
        $SQL = "UPDATE love_keyin SET all_branch = '".SqlFilter($_REQUEST["branch"],"tab")."', all_single = '".SqlFilter($_REQUEST["single"],"tab")."', all_type = '已發送' Where ac_auto =" .$ac_auto;
...
<body leftmargin="0" topmargin="0">
    <form action="ad_fun_send_love_all_branch.asp?state=add" method="post" name="form1">
    <table width="350" border="0" align="center">
        ...
        <td><fieldset>
            ...
            <tr bgcolor="#F0F0F0"> 
                ...
                <div>將 <?php echo SqlFilter($_REQUEST["ac_title"],"tab") ?> 這個活動的所有參加人員都分配給同一位</div>
                <div align="center"> 
                    <p><font color="#990066" size="3">請分配會館及秘書</font></p>
                    <p>會館： 
            ...
            <tr bgcolor="#FFF0E1"> 
                ...
                <div align="center"> 
                    ...
                    <input name="ac_auto" type="hidden" id="ac_auto" value="<?php echo $ac_auto; ?>">
                </div></td>
            </tr>
            </table>
            </fieldset></td>
