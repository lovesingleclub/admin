...
<form method="post" action="springweb_fun14_add.php?st=edit" onsubmit="return chk_form()">
    <p>廣告指定：<select name="ads" id="ads" style="height:30px;">
            <option value="">請選擇</option>
            <option value="1">廣告一</option>
            <option value="2">廣告二</option>
        </select></p>
    <p>
        <label>指向連結位置：</label>
    ...
    <p>../img/lovepy_noimg.jpg<br><img height=80 src="upload_image/../img/lovepy_noimg.jpg?t=4415" id="showimg"></p>
...
<script type="text/javascript">
    $(function() {
        $(".fileupload").each(function() {
            ...
            $this.fileupload({
                    url: "springweb_fun14_add.php?st=upload&an=",
                    type: "POST",
                    dropZone: $this,
                    dataType: 'html',
                    autoUpload: false,
                    ...
                    add: function(e, data) {
                        ...
                        if (data.files) {
                            ...
                            data.url = "springweb_fun14_add.php?st=upload&d1=" + $("#d1").val() + "&v=" + $('#ads').val() + "&an=";
                            data.submit();
